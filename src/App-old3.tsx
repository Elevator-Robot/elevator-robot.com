...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      {/* Brain In Cup Highlight */}
      <section className="section-revolutionary section-dark" style={{ overflow: 'visible' }}>
          ...
          <div className="text-center mb-12 advanced-animate">
            <div className="inline-flex items-center gap-4 mb-6">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="logo-orb group relative"
                style={{ 
                  width: '120px', 
                  height: '120px',
                  cursor: 'pointer',
            ...
            <p className="about-text stagger-child max-w-3xl mx-auto">
              Our flagship AI workspace bringing together image generation, text generation, and chat—all in one place. 
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-block mt-6 px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full hover:scale-105 transition-transform font-semibold"
            >
              Try Brain In Cup →
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 advanced-animate">
            ...
            <p className="hero-subtitle text-white stagger-child max-w-3xl mx-auto">
              We build AI-powered tools that help creators make amazing things. 
              From image generation to AI writing, our suite of applications empowers your creative workflow.
            </p>
          </div>
