...
const IndexPage = () => {
  ...
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)("main", {
    ...
    id: "chatContainer"
  }, messages.map((messageObj, index) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
    key: index,
    className: messageObj.user === "user" ? `${messageContainerStyles} ${messageStyles}` : botMessageStyles
  }, messageObj.message))), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)("form", {
    onSubmit: handleChatInputSubmit,
    className: formStyles
  }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)("input", {
    type: "text",
    value: chatInput,
