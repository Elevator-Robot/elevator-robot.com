...
[![Built with Amplify Gen2](https://img.shields.io/badge/Amplify-Gen2-orange)](https://docs.amplify.aws/)
...
- **Backend**: AWS Amplify Gen2, Lambda, DynamoDB, SES
...
**TL;DR**: You can use, modify, and share this code for non-commercial purposes with attribution. The "Elevator Robot" name and branding are protected trademarks. For commercial use, contact us.
